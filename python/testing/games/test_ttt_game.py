...
class TestTicTacToeGame(unittest.TestCase):
    ...
    def test_other_player(self):
        ...
        game = Game(players)
        self.assertEqual(ttt_config['pieces'][0], game.turn, "Piece 1 always goes first.")
        self.assertEqual(ttt_config['pieces'][1], game.get_other_player(), "Piece 2 should have the next turn.")
    ...
    def test_move(self):
        ...
        self.assertEqual(ttt_config['pieces'][0], game.game_board.board[1][1], "Piece should be placed on the board.")
        self.assertEqual(ttt_config['pieces'][1], game.turn, "Piece 2 should have this turn.")
        self.assertEqual(ttt_config['pieces'][0], game.get_other_player(), "Piece 1 should have the next turn.")
    ...
    def test_wrong_move(self):
        ...
        self.assertEqual(ttt_config['pieces'][0], game.turn, "Nothing should have changed. Player's 1 turn.")
        self.assertEqual(ttt_config['pieces'][1], game.get_other_player(), "Piece 2 should have the next turn.")
